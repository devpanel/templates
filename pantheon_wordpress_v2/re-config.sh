...
PANTHEON_DEV_STATIC_FILES_PATH="$WEB_ROOT/wp-content/uploads/files_dev"
PANTHEON_TEST_STATIC_FILES_PATH="$WEB_ROOT/wp-content/uploads/files_test"
PANTHEON_LIVE_STATIC_FILES_PATH="$WEB_ROOT/wp-content/uploads/files_live"
